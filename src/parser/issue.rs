...
#[macro_export]
macro_rules! __internal_issue_report {
...
#[macro_export]
macro_rules! __internal_issue_bail {
    ($state:expr, $issue:ident($($args:expr),+$(,)?)$(,)?) => {
        {
            let issue = $crate::parser::issue::$issue($state, $($args,)+);
...
pub(crate) use __internal_issue_bail as bail;
pub(crate) use __internal_issue_report as report;
